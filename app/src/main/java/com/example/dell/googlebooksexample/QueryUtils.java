...
import static com.example.dell.googlebooksexample.MainActivity.LOG_TAG;
    ...
    private static List<Book> extractFeatureFromJson(String bookJSON) {
        ...
        try {
            ...
            for (int i = 0; i < bookArray.length(); i++) {
                ...
                // Create a new {@link Book} object with the title, subTitle, pages,
                // and authors from the JSON response.
